...
def get_exchangeRateFluctuations():
    ...
    while current_date <= END_DATE:
        ...
        end_of_period = current_date + datetime.timedelta(hours=23, minutes=59, seconds=59)
        usd_to_lbp_rate, lbp_to_usd_rate = getExchangeRates(start_of_period, end_of_period)
        ...
        statistics[start_of_period+'|'+end_of_period] = (usd_to_lbp_rate, lbp_to_usd_rate)
